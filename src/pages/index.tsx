  ...
  return (
    <>
      <Head>
        ...
        <title>VPN by Oxy — Быстрый и безопасный VPN</title>
        <meta name="description"
              content="Молниеносный VPN для вашей приватности. Безопасно, быстро, удобно. Подключайтесь через Telegram-бота!" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="robots" content="index, follow" />
        <meta name="author" content="VPN by Oxy Team" />
        <meta name="publisher" content="VPN by Oxy" />
        <meta name="theme-color" content="#00bcd4" />
        <meta httpEquiv="Content-Language" content="ru" />
        <link rel="canonical" href="https://vpn-by-oxy.ru/" />
        <link rel="alternate" hrefLang="ru" href="https://vpn-by-oxy.ru/" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:locale" content="ru_RU" />
        <meta property="og:url" content="https://vpn-by-oxy.ru/" />
        <meta property="og:title"
              content="VPN by Oxy — Быстрый и безопасный VPN" />
        <meta property="og:description"
              content="Молниеносный VPN для вашей приватности. Безопасно, быстро, удобно." />
        <meta property="og:image" content="/og-image.png" />
        {/* VK/OK-specific */}
        <meta property="vk:image" content="/og-image.png" />
        <meta property="ok:image" content="/og-image.png" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://vpn-by-oxy.ru/" />
        ...
        {/* Telegram */}
        <meta name="telegram:channel" content="@vpn_by_oxy" />

        {/* Яндекс.Дзен */}
        <meta name="yandex-verification" content="4780cac591b7601b" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebSite",
              "name": "VPN by Oxy",
              "url": "https://vpn-by-oxy.ru/",
              "description": "Молниеносный VPN для вашей приватности. Безопасно, быстро, удобно.",
              "inLanguage": "ru-RU",
              "publisher": {
                "@type": "Organization",
                "name": "VPN by Oxy",
      ...
      <div className="min-h-screen bg-background text-foreground">
        {/* Header */}
        <header
          className="border-b border-border/40 backdrop-blur supports-[backdrop-filter]:bg-background/60 fixed w-full z-50">
          <div
            className="container mx-auto px-4 h-14 sm:h-16 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <Shield className="h-6 w-6 sm:h-8 sm:w-8 text-primary" />
              <span className="text-lg sm:text-xl font-bold">VPN by Oxy</span>
            </div>
            <Button
              className="bg-primary hover:bg-primary/90 text-primary-foreground text-sm sm:text-base px-3 sm:px-4 py-2 sm:py-2">
              <MessageCircle className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
              <Link href="https://t.me/vpn_by_oxy_bot"
                    className="hidden xs:inline">Начать с бота</Link>
          ...
          <div className="container mx-auto px-4 sm:px-6 relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <span
                  className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent block sm:inline">
                  {" "}
                  защищена
                </span>
              </motion.h1>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Link href="https://t.me/vpn_by_oxy_bot"
                          className="hidden sm:inline">Получить VPN
                      сейчас</Link>
              ...
              >
                ...
                >
                  <CheckCircle
                    className="w-3 h-3 sm:w-4 sm:h-4 text-primary mr-1 sm:mr-2" />
                  Политика без логов
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, x: -20 }}
        ...
        <section className="py-12 sm:py-16 md:py-20 border-t border-border/40">
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div
              ...
              >
                <Card
                  className="bg-card border-border/50 hover:border-primary/20 transition-all duration-300 h-full">
              ...
              >
                <Card
                  ...
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      Оптимизированные серверы обеспечивают максимальную
                      скорость
              ...
              >
                <Card
                  ...
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      Управляйте своим VPN напрямую через наш удобный Telegram
                      бот
              ...
              >
                <Card
                  ...
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      Подключайте неограниченное количество пользователей к
                      одному
        ...
        <section className="py-12 sm:py-16 md:py-20 bg-muted/20">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p
                className="text-base sm:text-lg md:text-xl text-muted-foreground px-4 sm:px-0">
            ...
            <div
              ...
              <div className="text-center px-4 sm:px-0">
                <div
                  className="bg-primary w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-xl sm:text-2xl font-bold text-primary-foreground">
                  1
                </div>
            ...
            <Link href="https://t.me/vpn_by_oxy_bot"
                  className="text-center block w-44 m-auto mt-12">
              <Button
                size="lg"
            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                  ...
                  >
                    <div
                      className="bg-primary/10 w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center mx-auto mb-3">
                      <Infinity
              ...
              <div
                ...
                >
                  <Card
                    className="bg-card border-primary/50 hover:border-primary/70 transition-all duration-300 h-full relative">
                    <div
        ...
        {/* CTA Section */}
        <section
          className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-primary/10 via-transparent to-secondary/10">
        ...
        <footer className="border-t border-border/40 py-8 sm:py-12">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
              <div>
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <span className="text-lg font-bold">Vpn by Oxy</span>
                </div>
                <p className="text-muted-foreground">
                  Ваша приватность - наш приоритет. Безопасный, быстрый и
                  надежный
                  VPN сервис.
                </p>
              </div>
            ...
            <div
              className="border-t border-border/40 mt-8 pt-8 text-center text-muted-foreground">
              <p>&copy; 2024 VPN by Oxy. Все права защищены.</p>
            </div>
          </div>
        </footer>
      </div>
...
export async function getStaticProps() {
  return {
    props: {}, // можно добавить данные для страницы
  };
}
